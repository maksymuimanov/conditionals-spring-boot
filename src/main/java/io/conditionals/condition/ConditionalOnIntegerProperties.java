...
/**
 * Container annotation for repeatable {@link ConditionalOnIntegerProperty} declarations.
 *
 * <p>
 * This annotation is used by Java's {@link Repeatable} mechanism and may also be declared explicitly. Spring Boot
 * evaluates its {@link #value()} elements via {@link io.conditionals.condition.impl.OnIntegerPropertyCondition}
 * during the condition evaluation phase of configuration processing.
 * </p>
 *
 * <p><b>Semantics</b></p>
 * <ul>
 *     <li><b>Aggregation</b>: contained {@link ConditionalOnIntegerProperty} instances are aggregated with AND
 ...
 *     {@link ConditionalOnIntegerProperty} is also present, it is evaluated before container values.</li>
 * </ul>
 *
