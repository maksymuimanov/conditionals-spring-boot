 ...
 * {@code double}-valued configuration properties.
 *
 * <p>This annotation is backed by {@link io.conditionals.condition.impl.OnDoublePropertyCondition} and is
 ...
 *     <li>Values are resolved from {@link org.springframework.core.env.Environment} and converted to {@link Double}
 ...
 * <p>This annotation is {@link Repeatable} via {@link ConditionalOnDoubleProperties}. Each instance is
 * evaluated independently and outcomes are aggregated with AND semantics.</p>
 *
 * @author Maksym Uimanov
 * @since 1.0
 * @see io.conditionals.condition.impl.OnDoublePropertyCondition
 * @see ConditionalOnDoubleProperties
 */
